...
**Service** | **Status**
------------ | -------------
**Travis CI:** | [![Build Status](https://api.travis-ci.org/Blue-Labs/sqlmap.svg?branch=master)](https://api.travis-ci.org/Blue-Labs/sqlmap) [![python](https://img.shields.io/badge/python-2.7|3.6|3.7-yellow.svg)](https://www.python.org/)
