...
**Service** | **Status**
------------ | -------------
**Travis CI:** | [![Build Status](https://api.travis-ci.org/Blue-Labs/sqlmap.svg?branch=master)](https://api.travis-ci.org/Blue-Labs/sqlmap) [![Python 2.7|3.6|3.7](https://img.shields.io/badge/python-2.7|3.6|3.7-yellow.svg)](https://www.python.org/) 
